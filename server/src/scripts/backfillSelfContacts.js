/**
 * Give every User a linked self-record in the Contacts roster, copying their
 ...
 *
 *   node src/scripts/backfillSelfContacts.js
 */
...
async function run() {
  ...
  for (const user of users) {
    const self = await Contact.ensureSelf(user);
