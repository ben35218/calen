...
- **The booking form (add + edit) is ordered and furnished like the event
  ...
  - **No Confirmation # or Phone fields.** `confirmation` stays in the form
    ...
    assist schema dropped it. Phone is entered only via the Location view
