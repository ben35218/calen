...
- Follow-up chips come from the `suggest_followups` tool inside the same
  ...
  sits on an accent-filled disc the white-on-colour `CalenChatIcon` stands in)
