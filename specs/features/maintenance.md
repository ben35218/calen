...
- A `Chore` is the lighter household variant (recurrence, `assignedTo`,
  ...
  "Ask Calen", so the assistant can't assign a chore to a contact
...
- **"Ask Calen"** on the task, chore and item forms fills fields from a
