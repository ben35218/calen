...
- **Review-each queue:** with **Review each**, selected contacts are stepped
  ...
  `ContactForm`: a **Direct**-import review **hides the "Ask Calen"
  pill** (the details came straight from the phone — nothing to re-derive),
