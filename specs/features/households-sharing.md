...
- **Start fresh (the one way the version moves backwards):** a re-key in a
  ...
  issues a fresh HDK v1 and the account can save again. Normative rules in
