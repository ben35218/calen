...
tests:
  ...
  - mobile/src/lib/__tests__/{calendarData,calendarFeeds,calendarPrefs,calendarWindow,monthGrid,holidays,homeRegion,weatherSource,recurrence,tz,printCalendar,addons,occasions,recordStore,eventWhen,occurrenceShift,eventSave,eventAlerts}.test.ts
...
- **An all-day event's alerts are whole days, not minutes.** An all-day event has
  ...
  time and its departure-relative alert rows stay hidden on an all-day event.
