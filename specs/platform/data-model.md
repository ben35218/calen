...
- **Identity/keys:** `User` (email, name, timestamps, auth factors, public key,
  ...
  (`colors` id→hex, `order`, `groupOrder` — the sequence the audience sections
  list in — `hidden`, `deletedDefaults`, `alertsOff`), on the
