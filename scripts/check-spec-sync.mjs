...
const RULES = [
  ...
  { re: /^(server\/src\/routes\/(calendars|calendarChat|eventAttachments|invitations)\.js|mobile\/src\/screens\/calendar\/|mobile\/src\/lib\/(calendar|calendarData|eventRepeat|calendarKeys|holidays|householdRsvp|widgetSnapshot)\.ts|mobile\/src\/hooks\/useWidgetSnapshot\.ts|mobile\/(modules\/calen-widget|targets\/widget)\/|shared\/calendar\/)/, specs: ['specs/features/calendar.md'],
    tests: /^(server\/src\/test\/(calendarKeys|customCalendars|authorHiding|drop|reDrop|invitations)\.|shared\/calendar\/index\.test\.js$|mobile\/src\/(lib\/__tests__\/(calendarFeeds|calendarPrefs|calendarKeys|calendarWindow|holidays|recurrence|tz|eventRepeat|eventAlerts|eventSave|eventWhen|weatherSource|addons|householdRsvp|widgetSnapshot)\.|screens\/calendar\/(dayview\/)?__tests__\/))/ },
  ...
  { re: /^(server\/src\/routes\/(trips|tripsChat)\.js|mobile\/src\/screens\/trips\/|mobile\/src\/lib\/trip(Keys|Data|Attachments|Lodging)\.ts|mobile\/src\/components\/TripTimeline\.tsx|server\/src\/services\/tripSharing\.js)/, specs: ['specs/features/trips.md'],
    tests: /^(server\/src\/test\/(tripKeys|tripShare|tripAttachments)\.|server\/src\/services\/tripSharing\.test\.js$|mobile\/src\/lib\/__tests__\/(tripKeys|tripData|tripLodging|addons|shareInvite)\.|mobile\/src\/(components\/__tests__\/TripTimeline\.|screens\/trips\/__tests__\/))/ },
  { re: /^(server\/src\/routes\/contacts\.js|mobile\/src\/screens\/profile\/Contact(s|Detail|Form|Import)|mobile\/src\/lib\/(contactIndex|contactFields|selfContact)\.ts)/, specs: ['specs/features/contacts.md'],
    tests: /^(server\/src\/test\/contacts\.|mobile\/src\/lib\/__tests__\/(contactFields|vcard|phone|contactIndex)\.)/ },
  ...
  { re: /^(server\/src\/routes\/(calendarChat|choresChat|maintenanceChat|maintenancePlanChat|tripsChat|calls|formAssist)\.js|server\/src\/services\/(chatStream|chatSuggestions|aiUsage|phoneCalls)\.js|mobile\/src\/screens\/chat\/|mobile\/src\/components\/(FormAssistChat|AssistantButton)\.tsx|mobile\/src\/lib\/(aiPayload|chatLinks|formAssistTranscript)\.ts|mobile\/src\/hooks\/(useScrollAwareKeyboard|useDictation)\.ts)/, specs: ['specs/features/ai-assistant.md'],
    tests: /^(server\/src\/test\/aiPrivacy\.|server\/src\/services\/phoneCalls\.test\.js$|server\/src\/middleware\/usageMeter\.tokens\.test\.js$|server\/src\/routes\/formAssist\.multiTurn\.test\.js$|mobile\/src\/components\/__tests__\/FormAssistChat\.|mobile\/src\/lib\/__tests__\/(aiPayload|aiWindow|chatLinks|formAssistTranscript)\.|mobile\/src\/hooks\/__tests__\/(useScrollAwareKeyboard|useDictation)\.|mobile\/src\/screens\/chat\/__tests__\/)/ },
  ...
  { re: /^(server\/src\/routes\/notifications\.js|server\/src\/jobs\/scheduler\.js|server\/src\/services\/(push|notify)\.js|mobile\/src\/(lib\/(notifications|push|backgroundRefresh|securityNudges|discoverNudge|widgetNudge)\.ts|hooks\/(useReminderScheduler|usePushNotifications|useInviteAlerts|useSecurityNudges|useDiscoverNudge|useWidgetNudge)\.ts|screens\/profile\/RemindersScreen\.tsx))/, specs: ['specs/features/notifications.md'],
    tests: /^(server\/src\/test\/notifications\.|server\/src\/jobs\/scheduler\.test\.js$|mobile\/src\/lib\/__tests__\/(notifications|rescheduleReminders|inviteAlerts|securityNudges|discoverNudge|widgetNudge)\.)/ },
